...
const CustomSidebarMenu = props => {
  let items = [
    {
      navOptionName: 'User Screen',
      screenToNavigate: 'UserScreen',
    },
    {
    ...
    {
      navOptionName: 'Payment Screen',
      screenToNavigate: 'PaymentScreen',
    },
    {
    ...
    <View style={stylesSidebar.sideMenuContainer}>
      <View style={stylesSidebar.profileHeader}>
        <View style={stylesSidebar.profileHeaderPicCircle}>
          <Text style={{ fontSize: 25, color: '#943126' }}>
            {'SECRET React'.charAt(0)}
          </Text>
        </View>
        <Text style={stylesSidebar.profileHeaderText}>SECRET</Text>
      </View>
